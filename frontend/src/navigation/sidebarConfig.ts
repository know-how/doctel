...
export const sidebarConfig: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "admin-models", label: "Model Catalog", icon: "📦", path: "/admin/models" },
      { id: "admin-embeddings", label: "Embeddings", icon: "🧩", path: "/admin/embeddings" },
      { id: "admin-prompts", label: "Prompt Management", icon: "💬", path: "/admin/prompts" },
      { id: "admin-auto-routing", label: "Auto Routing", icon: "🚦", path: "/admin/auto-routing" },
  ...
  },
  {
    ...
    roles: ["admin"],
    children: [
      { id: "admin-storage", label: "Storage", icon: "💾", path: "/admin/storage" },
      { id: "admin-integrations", label: "Integrations", icon: "🔌", path: "/admin/integrations" },
      { id: "admin-security", label: "Security", icon: "🔒", path: "/admin/security" },
      { id: "admin-rbac", label: "RBAC", icon: "👥", path: "/admin/rbac" },
      { id: "admin-departments", label: "Departments", icon: "🏛️", path: "/admin/departments" },
      { id: "admin-diagnostics", label: "Diagnostics", icon: "🩺", path: "/admin/diagnostics" },
      { id: "admin-audit", label: "Audit", icon: "📋", path: "/admin/audit" },
    ],
  },
  {
    id: "collaboration",
